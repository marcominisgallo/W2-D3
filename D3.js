...
for (let i = 0; i < starWarsCharacters.length; i++) {
  switch (starWarsCharacters[i].eye_color) {
    ...
    case "blue-gray":
      ...
      break;
    default:
      console.log("No eye color found");
  }
}
...
console.log("starWarsCharacters gender", starWarsCharacters);
...
console.log("charactersNames length 1", charactersNames.length);

for (let i = 0; i < femaleCharacters.length; i++) {
  let index = charactersNames.indexOf(femaleCharacters[i]);
  if (index > -1) {
    charactersNames.splice(index, 1);
  }
}

console.log("charactersNames length 2", charactersNames.length);

/* --EXTRA-- ESERCIZIO 10
  Crea una funzionalità che selezioni un elemento casuale dall'array "starWarsCharacters" e ne stampi in console le proprietà in modo discorsivo (a tuo piacimento).
*/

/* Cercando su google penso si debba creare una 'function', ma non capisco molto bene il suo utilizzo.
 */
